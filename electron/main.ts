...
import { setupIssueCommentHandlers } from './ipc/issue-comments';
import { setupIssueActivityHandlers } from './ipc/issue-activities';
...
app.whenReady().then(async () => {
    ...
    setupIssueCommentHandlers();
    setupIssueActivityHandlers();
