...
const api = {
    ...
    auth: {
        ...
        updatePassword: (currentPassword: string, newPassword: string) =>
            ipcRenderer.invoke('auth:updatePassword', currentPassword, newPassword),
    },

    // Issue Comments
    issueComments: {
        getAll: (issueId: string) => ipcRenderer.invoke('issue-comments:getAll', issueId),
        create: (data: { issueId: string; content: string; authorId: string }) =>
            ipcRenderer.invoke('issue-comments:create', data),
        update: (id: string, content: string) => ipcRenderer.invoke('issue-comments:update', id, content),
        delete: (id: string) => ipcRenderer.invoke('issue-comments:delete', id),
    },

    // Issue Activities
    issueActivities: {
        getAll: (issueId: string) => ipcRenderer.invoke('issue-activities:getAll', issueId),
        create: (data: { issueId: string; userId: string; activityType: string; details?: any }) =>
            ipcRenderer.invoke('issue-activities:create', data),
    },
};
